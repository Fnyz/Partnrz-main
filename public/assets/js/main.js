function initPartnrz() {
    ...
    function firstLoad() {
        ...
        TweenMax.to($(".pz-loading-text-wrap"), 1.0, {
            force3D: true,
            y: "-150px",
            opacity: 0,
            ease: Expo.easeInOut,
            delay: 1.2,
            onComplete: function () {
                TweenMax.to($(".pz-loader-anim"), 0.8, {
                    force3D: true,
                    bottom: "100%",
                    ease: Expo.easeInOut,

                });
                TweenMax.to($(".pz-loader-anim2"), 0.8, {
                    force3D: true,
                    bottom: "100%",
                    delay: 0.2,
                    ease: Expo.easeInOut,
        ...
        var chdpt = $(".pz-content").data("pagetitle");
        $(".pz-page-subtitle span").text(chdpt);
    }
    //   Background image ------------------
    var a = $(".pz-bg");
    a.each(function (a) {
        ...
        if ($("#portfolio_horizontal_container").length) {
            ...
            d.imagesLoaded(function (a, b, e) {
                ...
                $(".horizontal-grid-wrap").scroll(function () {
                    ...
                    $(".pz-js-progress").css("stroke-dashoffset", 100 - (scrolled));
                });
    ...
    if ($(".home-half-slider").length > 0) {
        ...
        j.on("slideChangeTransitionStart", function () {
            $(".pz-hero-corner").addClass("pz-start-anim");
            $(".slider-progress-bar").removeClass("pz-act-slider");
        });
        j.on("slideChangeTransitionEnd", function () {
            $(".pz-hero-corner").removeClass("pz-start-anim");
            $(".slider-progress-bar").addClass("pz-act-slider");
        });
    ...
    if ($(".pz-testimonials").length > 0) {
        var j2 = new Swiper(".pz-testimonials .swiper-container", {
            preloadImages: false,
            slidesPerView: 2,
            spaceBetween: 10,
            loop: true,
    ...
    if ($(".fs-slider").length > 0) {
        $(".fs-slider.thumb-contr .swiper-slide .pz-bg").each(function () {
    ...
    if ($(".pz-slideshow-wrap").length > 0) {
        var ms1 = new Swiper(".pz-slideshow-wrap .swiper-container", {
            preloadImages: false,
            loop: true,
            speed: 1400,
            spaceBetween: 0,
    ...
    if ($(".pz-grid-carousel ").length > 0) {
        var totalSlides2 = $(".pz-grid-carousel .swiper-slide").length;
        var gridCarusel = new Swiper(".pz-grid-carousel .swiper-container", {
            preloadImages: true,
            loop: true,
            centeredSlides: false,
            freeMode: false,
            ...
            speed: 1400,
            navigation: {
                nextEl: '.pz-carousel-next',
                prevEl: '.pz-carousel-prev',
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
    ...
    $(".pz-skillbar-wrap").appear(function () {
        $(this).find("div.pz-skillbar-track").each(function () {
            $(this).find(".pz-skillbar").delay(600).animate({
    ...
    var ssl_total = $("section.pz-scroll-sec").length;
    $(".sc_total").text("0" + ssl_total);
    // scroll nav ------------------
    $(".pz-scroll-nav-wrap ").singlePageNav({
        filter: ":not(.external)",
        updateHash: false,
        offset: 70,
        threshold: 120,
        speed: 1200,
        currentClass: "pz-act-sec"
    });
    //   scroll to------------------
    ...
    // progressBar ------------------
    var progressBar = $(".pz-js-progress");
    var $window = $(window);
    ...
    function csselem() {
        ...
        $(".pz-ms-item").css({
            height: $(".pz-slideshow-wrap").outerHeight(true)
        });
    ...
    $(".accordion a.toggle").on("click", function (a) {
        a.preventDefault();
        $(".accordion a.toggle").removeClass("pz-act-accordion");
        $(this).addClass("pz-act-accordion");
    ...
    //   nicescroll ------------------
    $(".pz-process-content-wrap").niceScroll({
        cursorwidth: "2px",
        cursorborder: "none",
        cursorborderradius: "0px",
        cursorcolor: "#F57500",
    ...
    $(".pz-show-phdc").on("click", function () {
        var pdch = $(this).parent(".pz-process-item").find(".pz-process-content");
    ...
    $(".pz-close-pdcw").on("click", function () {
        var pdch = $(this).parents(".pz-process-item").find(".pz-process-content");
    ...
    function showDetails() {
        ...
        TweenMax.to($(".pz-hid-det-anim"), 0.8, {
            force3D: true,
            left: "0",
            ease: Expo.easeInOut,
            onComplete: function () {
    ...
    hoverdirInit();
    //   cursor ------------------
    $(".pr-det-container , .pz-col-wrap").on({
        mouseenter: function () {
            $(".pz-cursor-item").addClass("pz-cursor-blur");
        },
        mouseleave: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-blur");
        }
    });
    $(".pz-col-wrap.pz-dark-bg").on({
        mouseenter: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-blur");
        },
        mouseleave: function () {
    ...
    $("a , .pz-btn ,   textarea,   input  , .leaflet-control-zoom , .aside-show_cf , .close-contact_form , .closedet_style ").on({
        mouseenter: function () {
            $(".pz-cursor-item").addClass("pz-cursor-hover");
        },
        mouseleave: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-hover");
        }
    });
    $("  .swiper-slide ,  #portfolio_horizontal_container").on({
        mouseenter: function () {
            $(".pz-cursor-item").addClass("pz-cursor-swipe");
        },
        mouseleave: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-swipe");
        }
    });
    ...
    $(".next-project-swiper-link").on({
        mouseenter: function () {
            $(".pz-cursor-item").addClass("pz-cursor-linknext");
        },
        mouseleave: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-linknext");
        }
    });
    $(".pz-nav-overlay , .det-overlay").on({
        mouseenter: function () {
            $(".pz-cursor-item").addClass("pz-cursor-close");
        },
        mouseleave: function () {
            $(".pz-cursor-item").removeClass("pz-cursor-close");
        }
    });
    //   Contact form------------------
    ...
    $(".show_contact-form").on("click", function (e) {
        e.preventDefault();
        $(".pz-content-inner").addClass("vis-con-form");
    });
    $(".close-contact_form").on("click", function () {
        $(".pz-content-inner").removeClass("vis-con-form");
        $("#message").slideUp(500);
        $(".custom-form").find("input[type=text], textarea").val("");
    });
    if ($(".pz-video-wrap").length > 0) {
    function videoint() {
        //   Video------------------
        ...
        var w = $(".background-vimeo").data("vim"),
            ...
            vch = $(".pz-video-container");
        bvc.append('<iframe src="//player.vimeo.com/video/' + w + '?background=1"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen ></iframe>');
        $(".pz-video-holder").height(bvmc.height());
        if ($(window).width() > 1024) {
            if ($(".pz-video-holder").length > 0)
    ...
    //   Blog filter ------------------
    $(".pz-blog-btn").on("click", function () {
        $(this).parent(".pz-blog-btn-filter").find("ul").slideToggle(500);
        return false;
    });
    //   mobile filter ------------------
    $(".pz-act-filter").on("click", function () {
        $(".init_hidden_filter").slideToggle(300);
        return false;
    });
    $(".pz-scroll-nav-wrap ul li a  , .gallery-filters a").on("click", function () {
        if ($(window).width() < 565) {
    ...
    //  menu------------------
    $("#menu").menu();
    $(".pz-sliding-menu li a.nav").parent("li").addClass("submen-dec");
    var nbw = $(".pz-nav-button"),
        nh = $(".pz-nav-holder"),
        nhw = $(".pz-nav-holder-wrap"),
        nho = $(".pz-nav-overlay"),
        nhl = $(".pz-nav-holder-line"),
        nnvw = $("nav.pz-nav-inner"),
        nfw = $(".pz-nav-footer"),
        nhwd = $(".pz-nav-holder-dec");
    function showMenu() {
        nh.addClass("nh_vis");
        nho.fadeIn(500);
    ...
    function hideMenu() {
        ...
        nhw.addClass("pz-btn-wrap");
        nbw.removeClass("cmenu");
    }
    nbw.on("click", function () {
        if (nhw.hasClass("pz-btn-wrap")) showMenu();
        else hideMenu();
    });
    ...
    // Share   ------------------
    $(".pz-share-container").share({
        networks: []
    });
    var shrcn = $(".pz-share-container"),
        swra = $(".pz-share-panel"),
        clsh = $(".pz-share-close"),
        shic = $(".pz-share-icon"),
        ssbtn = $(".pz-showshare");
    function showShare() {
        ssbtn.addClass("pz-share-uncl");
        shrcn.removeClass("pz-is-share");
    ...
    function hideShare() {
        ssbtn.removeClass("pz-share-uncl");
        shrcn.addClass("pz-is-share");
        TweenMax.to($(".pz-share-icon"), 1.0, {
            force3D: false,
            opacity: "0"
        });
        TweenMax.to(clsh, 0.4, {
    ...
    ssbtn.on("click", function () {
        if ($(".pz-share-container").hasClass("pz-is-share")) showShare();
        else hideShare();
    });
}
//   load animation------------------
$("<div class='pz-page-load'><span class='pz-spinner'></span></div>").appendTo("#main");
$.fn.duplicate = function (a, b) {
    var c = [];
    for (var d = 0; d < a; d++) $.merge(c, this.clone(b).get());
    return this.pushStack(c);
};
$("<div class='pz-pl-row'><span class='pz-pl-row-anim'></span><span class='pz-pl-row-anim2'></span></div>").duplicate(4).appendTo(".pz-page-load");
function contentAnimShow() {
    $(".lg-backdrop , .lg-outer").remove();
    $(".pz-nav-button").removeClass("cmenu");
    $(".pz-showshare").removeClass("pz-share-uncl");
    $(".pz-page-load").fadeIn(1);
    $(".pz-pl-row-anim2").each(function(index, el) {
    ...
    $(".pz-pl-row-anim").each(function(index, el) {
        var tl = new TimelineLite();
        tl.to(el, 0.8, {
            force3D: true,
    ...
    TweenMax.to($(".pz-page-subtitle span"), 0.9, {
        force3D: true,
        y: -50,
        opacity: 0,
        delay: 0.7,
        ease: Power2.easeOut,
        onComplete: function () {
            TweenMax.to($(".pz-page-subtitle span"), 0.1, {
                force3D: true,
                y: 50
            });
        }
...
function contentAnimHide() {
    ...
    $(".pz-page-load").addClass("act_pl");
    $(".pz-spinner").addClass("pz-act-loader");
    setTimeout(function () {
        $(".pz-spinner").removeClass("pz-act-loader");
        $(".pz-page-load").removeClass("act_pl");
        $(".pz-pl-row-anim").each(function(index, el) {
            var tl = new TimelineLite();
            tl.to(el, 0.6, {
                force3D: true,
        ...
        setTimeout(function () {
            $(".pz-page-load").fadeOut(1);
            TweenMax.to($(".pz-pl-row-anim , .pz-pl-row-anim2"), 0.0, {
                force3D: true,
                left: "0",
                right: "100%"
            });
...
if ($(".pz-cursor-item").length > 0) {
    ...
    var ratio = 0.15;
    var active = false;
    var ball = document.querySelector('.pz-cursor-item');
    TweenLite.set(ball, {
        xPercent: -50,
        yPercent: -50
    });
